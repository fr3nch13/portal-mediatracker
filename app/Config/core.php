 ...
 *
 */
Configure::write('Routing.prefixes', array('admin', 'regular', 'reviewer'));
...
Configure::write('Site.title', __('Portal: Media Tracker'));
 ...
 */
	...
	Configure::write('AppConfigKeys', array(
		...
		'Dialogues.closing' => array(
			'label' => __('%s Closing Alert Dialogue', __('Media')), 
			'type' => 'textarea',
		),
		'Dialogues.opening' => array(
			'label' => __('%s Opening Alert Dialogue', __('Media')), 
			'type' => 'textarea',
		),
		...
		'Dialogues.deletecoc' => array(
			'label' => __('%s Deleting Alert Dialogue', __('Chain of Custody')),
			'type' => 'textarea',
		),
	));
